...
namespace MockNet04G2.Core.Migrations
{
    ...
    [Migration("20240920045737_UpdateAmountContentImage")]
    partial class UpdateAmountContentImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MockNet04G2.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admin",
                            Password = "$2a$11$QViGL43ARzT.wFuuh0VRten5W4UGoVz8ALsv9nyXi9QCyBHB6Lr8O",
                            Phone = "0375769058",
                            Role = 1
                        });
                });
